...
GET_LIST_ORDERS(()->{
    ...
    SORT_ORDER_BY_DATA(() -> {
        try {
            ...
            System.out.println("Заказов со статусом исполнены - нет");
        }
    }),
    ...
    ADD_BOOK(() -> {
        ...
        //bookService.addNewBookToRepository(new Book(name,author,yearOfPublic,price,statusBook,dateDelivery));
