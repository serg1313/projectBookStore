...
public class BookRepositoryImpl implements BookRepository {
    ...
    public BookRepositoryImpl() {
        log.info("the constructor is called BookRepositoryImpl");
        initData();
    }

    public static BookRepository getBookRepository() {
        log.info("calling a method getBookRepository");
    ...
    private void initData() {
        log.info("calling a method initData");
...
//        books.add(new Book("Лагерь", "Эл К. Розен", 2010, 250, true, LocalDate.of(2022, 1, 5)));
        log.info("method initData completed");
    }
    ...
    public List<Book> getBooks() {
        log.info("calling a method getBooks");
        log.info("method getBooks completed");
        return books;
    }
    ...
    public void addNewBookInRepository(Book book) {
        log.info("calling a method addNewBookInRepository");
        ...
        log.info("method addNewBookInRepository completed");
    }

    @Override
    public void addNewBook(Book book) {
        log.info("calling a method addNewBook");
        ...
        log.info("method addNewBook completed");
    }
}
